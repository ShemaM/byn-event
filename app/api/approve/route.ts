...
async function markApproved(email: string) {
  ...
  // Update column O (Approved) to "Yes"
...
export function buildConfirmationEmail(name: string, activities: string) {
  return `
<!DOCTYPE html>
<html>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#ffffff;padding:36px 40px;">
            <p style="margin:0 0 20px;font-size:15px;line-height:1.7;color:#333;">Hi <strong>${name}</strong>, your payment has been confirmed and your spot is secured. We are looking forward to seeing you.</p>
            ...
            <p style="margin:0 0 12px;font-size:14px;line-height:1.7;color:#555;">Please remember to bring your physical ID or passport on the day. Your name will be checked at the gate.</p>
            <p style="margin:0;font-size:14px;line-height:1.7;color:#555;">If you have any questions, reply to this email.</p>
          </td>
        </tr>
        <tr>
  ...
  try {
    await Promise.all([
      transporter.sendMail({
        ...
        html: buildConfirmationEmail(name, activities),
      }),
      markApproved(email),
    ])
