...
// Blue: #1B4FBB | Yellow: #F5C518 | Red: #D72B2B
...
export default function RegistrationPage() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-[#1B4FBB] flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-white p-10 text-center shadow-2xl">
          ...
          <h2 className="text-2xl font-black text-[#1B4FBB] mb-3">You&apos;re in!</h2>
          ...
          <div className="mt-8 h-1 w-full" style={{ background: 'linear-gradient(to right, #D72B2B, #F5C518, #1B4FBB)' }} />
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Header */}
      <div className="bg-[#1B4FBB] px-6 py-10">
        <div className="max-w-xl mx-auto">
          <div className="flex items-center gap-4 mb-7">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/logo.png" alt="Banyamulenge Youth Kenya" className="w-14 h-14 object-contain" />
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.22em] text-white/50">Banyamulenge Youth Kenya</p>
          ...
          <h1 className="text-3xl font-black text-white leading-tight">
            Youth Get-Together
            <br />
            <span className="text-[#F5C518] font-black text-2xl">July 4, 2026</span>
            <span className="text-white/50 font-normal text-xl"> · USIU-Africa, Nairobi</span>
          </h1>
          <div className="mt-5 space-y-3 max-w-lg">
            <p className="text-sm text-white/75 leading-7">
              The Banyamulenge Youth Network Kenya is hosting a casual event for young Banyamulenge people living in Kenya to meet, talk, share stories, and build friendships for the future. It is also a networking event for sharing opportunities and hearing testimonials for you to know what to expect from the event.
            </p>
            <p className="text-sm text-white/60 leading-7">
              This form helps us see who is coming, what you are studying or working on, and what topics you want to talk about at the meetup.
            </p>
            <p className="text-sm text-white/60 leading-7">
          ...
          {/* Directions */}
          <div className="mt-6 border border-white/15 bg-white/5 p-5 max-w-lg">
            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#F5C518] mb-4">Getting There — USIU-Africa, Nairobi</p>
            <div className="space-y-4">
              <div className="flex gap-3">
                <div className="mt-1 w-2 h-2 rounded-full bg-[#D72B2B] shrink-0" />
                <div>
                  ...
                  <p className="text-xs text-white/60 leading-6">
                    Board any <strong className="text-white/80">Thika Road matatu</strong> and alight at <strong className="text-white/80">Safari Park Hotel</strong>. From there, USIU-Africa is a short distance away — you can walk, or take a <strong className="text-white/80">boda boda (KES 70)</strong> or the <strong className="text-white/80">yellow van (KES 30)</strong> to the gate.
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="mt-1 w-2 h-2 rounded-full bg-[#F5C518] shrink-0" />
                <div>
                  <p className="text-xs font-black text-white uppercase tracking-wide mb-1">From Thika · Juja · Githurai · Kasarani</p>
                  <p className="text-xs text-white/60 leading-6">
                    Board any matatu heading <strong className="text-white/80">towards Nairobi</strong> and alight at <strong className="text-white/80">Safari Park Hotel</strong>. From there, take a <strong className="text-white/80">boda boda (KES 70)</strong> or the <strong className="text-white/80">yellow van (KES 30)</strong> to USIU gate, or walk if you prefer.
                  </p>
                </div>
              </div>
            </div>
            <p className="mt-4 text-[10px] text-white/35 leading-5">
              📍 <span className="text-white/55">Exit 7, USIU Road, Off Thika Rd</span> · Google Maps: search <span className="text-white/55 font-mono">USIU-Africa Nairobi</span>
            </p>
          </div>
            ...
            {[
              ...
              <div key={n} className="flex items-center gap-2">
                <div className="flex flex-col items-center gap-1">
                  ...
                  <span className="text-[9px] font-bold uppercase tracking-wider" style={{ color: step === n ? '#F5C518' : 'rgba(255,255,255,0.35)' }}>
                    {label}
                  </span>
                </div>
                {i < arr.length - 1 && (
                  <div className="w-10 h-[2px] mb-4 transition-colors" style={{ background: step > n ? '#F5C518' : 'rgba(255,255,255,0.2)' }} />
                )}
              </div>
            ))}
          </div>
        ...
        {step === 1 && (
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500">Step 1 — Basic Information</p>
            </div>
            ...
            <button type="button" onClick={next} disabled={!canProceed1}
              className="w-full py-3.5 text-sm font-black uppercase tracking-[0.12em] text-white disabled:opacity-40 transition-colors"
              style={{ background: canProceed1 ? '#1B4FBB' : '#9ca3af' }}>
              Continue →
            </button>
          </div>
        )}
        ...
        {step === 2 && (
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500">Step 2 — Networking &amp; Engagement</p>
            </div>
            ...
            <div className="flex gap-3">
              <button type="button" onClick={back}
                className="flex-1 border-2 border-gray-300 px-4 py-3.5 text-sm font-black uppercase tracking-[0.12em] text-gray-600 hover:border-[#1B4FBB] hover:text-[#1B4FBB] transition-colors bg-white">
                ← Back
              </button>
              <button type="button" onClick={next} disabled={!canProceed2}
                className="flex-[2] py-3.5 text-sm font-black uppercase tracking-[0.12em] text-white disabled:opacity-40 transition-colors"
                style={{ background: canProceed2 ? '#1B4FBB' : '#9ca3af' }}>
                Continue →
              </button>
            </div>
          </div>
        ...
        {step === 3 && (
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500">Step 3 — Contribution &amp; Consent</p>
            </div>
            ...
            <div className="overflow-hidden">
              ...
              <div className="bg-[#1B4FBB] text-white p-6">
                ...
                <div className="border border-white/20 bg-white/10 px-5 py-4 mb-4">
                  ...
                  <p className="text-2xl font-black text-white tracking-wide">+254 799 978876</p>
                  <p className="text-[11px] mt-1" style={{ color: '#F5C518' }}>Amount: KES 500</p>
                </div>
            ...
            <div className="space-y-4">
              ...
              <Field label="M-Pesa confirmation code" required>
                <input type="text" value={form.mpesaCode} onChange={(e) => set('mpesaCode', e.target.value.toUpperCase())}
                  placeholder="e.g. QJK1234ABC"
                  className={`${INPUT} font-mono tracking-widest`} required />
              </Field>
            </div>
      ...
      {/* Footer stripe */}
      <div className="h-1" style={{ background: 'linear-gradient(to right, #D72B2B 33%, #F5C518 33%, #F5C518 66%, #1B4FBB 66%)' }} />
    </div>
  )
}
